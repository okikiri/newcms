...
?>
			...
			?>
					...
					<table align="center">
					   <tr>
					    <td>
							<p align="center"><font size="20">Welcome Students!</font></h1>
						<td>
					   </tr>
					    <tr>
						  <td>
			...
			<table align="center">
			  <tr>
			     <td>
            	<form action="validator.php" method="post" name="login" onSubmit="return validateForms()"">
					Reg.no: </h1><br><input type="text" name="regno" /><br>
        ...
        <h1 align="center">New student? <a href="indexstud.php">CREATE ACCOUNT</a><h1>
  <p align="center">&nbsp;</p>
      <center>
        <!--<a href="about.php"><img src="admin/images/ahmad.jpg" alt="Developed by Ahmad Mushtaq" width="395" height="32" border="0" /></a>-->
      </center>
    <p align="left">&nbsp;</p></td>
  </tr>
</table>
